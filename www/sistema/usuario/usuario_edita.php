...
***** APLICAÇÃO
***** Guia Doméstico
***** Arquivo: /sistema/usuario/usuario_edita.php
***** Conteúdo: Edição do Usuário
...
if ($Acao == "EDITAR") {
  ...
  $html_submenu .= '    <h5>Cadastro de Usuários do Portal</h5>' . "\n";
	$html_submenu .= '  </div>' . "\n";
	$html_submenu .= '</div>' . "\n";
	$html_submenu .= '<div class="row mb-1">' . "\n";
	$html_submenu .= '  <div class="col-12">' . "\n";
...
<head>
<title>Guia Doméstico - Edição de Usuário</title>
        ...
        <div class="card mt-4">  
          ...
          <div class="card-body">
            <div class="row small" style="padding:10px">
              <form method="POST" action="<?php echo $Raiz ?>sistema/usuario/usuario_edita.php" id="FUSUARIO_EDITA" name="FUSUARIO_EDITA">
                ...
                <div class="row mb-1">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="nome_usuario" name="nome_usuario" placeholder="Nome do usuário" value="<?php echo $nome_usuario ?>">
                  </div>
                </div>
                <div class="row mb-1">
                  <label for="email_usuario" class="col-sm-2">Email</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="email_usuario" name="email_usuario" placeholder="Nome de acesso" value="<?php echo $email_usuario ?>">
                  </div>
                </div>
                <div class="row mb-1">

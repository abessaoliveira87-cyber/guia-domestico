...
<!--  
  <div class="row">
    <div class="col ml-2 mr-2" style="padding-top:20px;" align="center">
      <a href="#" target="_blank"><i class="CorTextoOut fab fa-2x mr-4 fa-facebook-square"></i></a>
      <a href="#" target="_blank"><i class="CorTextoOut fab fa-2x mr-4 fa-instagram"></i></a>
      <a href="#" target="_blank"><i class="CorTextoOut fab fa-2x mr-4 fa-linkedin"></i></a>
    </div>
  </div>
-->  
  ...
  <div class="row mb-5">
    ...
    <div class="col-sm-6 texto-rodape texto-suave text-end">
      <span style="font-size:12px"><a href="#" class="sem-decoracao" target="_parent">Termos de uso</a></span>
      <span style="text-nowrap">&nbsp;-&nbsp;</span>
      <span style="font-size:12px"><a href="#" class="sem-decoracao" target="_parent">Privacidade</a></span>
    </div>
  </div>
<!--  
  <div class="row mb-5">
    <div class="col-sm-12 Texto-Rodape text-end">
      <span style="font-size:12px"><a href="https://univesp.br" target="_blank">Desenvolvido por: Turma A2026S1N2 - Univesp.</a></span>
    </div>
  </div>
-->  
</div>